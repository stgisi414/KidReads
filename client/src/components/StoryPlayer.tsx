                                          ...
                                          export default function StoryPlayer({ story }: StoryPlayerProps) {
                                            ...
                                            const onTranscriptionUpdate = useCallback((transcript) => {
                                              ...
                                              setCurrentWordIndex(prevIndex => {
                                                const currentWord = story.words[prevIndex]?.toLowerCase().trim() || ""; // Get fresh currentWord

                                                // Log exact match attempt
                                                console.log('Speech Recognition Results:', {
                                                  heard: heardText,
                                                  expecting: currentWord,
                                                  wordIndex: prevIndex // Use prevIndex here
                                                });
                                                ...
                                                const foundMatch = heardWords.some(heardWord => {
                                                  const isExactMatch = heardWord === currentWord; // Compare with freshly derived currentWord
                                                  ...
                                                  console.log('Word comparison:', {
                                                    ...
                                                    isExactMatch,
                                                    containsWord,
                                                    currentWordIndex: prevIndex // Use prevIndex here
                                                  });
                                            ...
                                            }, [story, toast]); // Correct dependencies
